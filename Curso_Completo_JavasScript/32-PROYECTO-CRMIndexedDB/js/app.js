...
(function () {
    ...
    // creamos la fn obtenerClientes, 

    function obtenerClientes() {
        const abrirconexion = window.indexedDB.open('crm',1);

        abrirconexion.onerror =function () {
            console.log('hubo un error , porfavor arreglar');
        }
        abrirconexion.onsuccess =function () {
            ...
            objectStore.openCursor().onsuccess = function (e) {
                ...
                if (cursor) {
                   ...
                   const listandoClientes = document.querySelector('#listado-clientes');
                   listandoClientes.innerHTML += ` <tr>
